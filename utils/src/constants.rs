...
pub const BGEU: &'static str = "bgeu";
...
pub const DIR_JUMP_OPS: [&'static str; 8] = [BEQ, BNE, BLT, BGE, BGEU, BEQZ, BLTU, JAL];
pub const JUMP_OPS: [&'static str; 10] = [BEQ, BNE, BLT, BGE, BGEU, BEQZ, BLTU, JAL, JALR, MRET];
